...
/**
 * `format` is used to format text using Prettier. [Options](https://prettier.io/docs/en/options.html) may be provided to override the defaultimport { CursorOptions, CursorResult, Options, SupportInfo } from './';
