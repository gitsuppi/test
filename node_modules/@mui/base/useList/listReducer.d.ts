...
/**
 * Gets the next item to highlight based on the current highlighted item and the searcimport { ListState, ListReducerAction, ListActionContext, SelectionMode } from './useList.types';
/**
